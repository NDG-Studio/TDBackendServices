...
namespace ZTD.Migrations
{
    ...
    [Migration("20230316102250_wave-difficulty-added")]
    partial class wavedifficultyadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZTD.Entities.Dialog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZTD.Entities.DialogScene", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ZTD.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstLogInDate = new DateTimeOffset(new DateTime(2023, 3, 16, 13, 22, 50, 734, DateTimeKind.Unspecified).AddTicks(5880), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsAndroid = true,
                            IsApe = true,
                            IsTutorialDone = false,
                            LastSeen = new DateTimeOffset(new DateTime(2023, 3, 16, 13, 22, 50, 734, DateTimeKind.Unspecified).AddTicks(5930), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("ZTD.Entities.Dialog", b =>
                {
                    b.HasOne("ZTD.Entities.DialogScene", "DialogScene")
                        .WithMany("Dialogs")
