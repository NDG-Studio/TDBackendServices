...
namespace ZTD.Migrations
{
    ...
    [Migration("20230213153157_researchnodes-added")]
    partial class researchnodesadded
    {
            ...
            modelBuilder.Entity("ZTD.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstLogInDate = new DateTimeOffset(new DateTime(2023, 2, 13, 18, 31, 57, 576, DateTimeKind.Unspecified).AddTicks(5430), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsAndroid = true,
                            IsApe = true,
                            IsTutorialDone = false,
                            LastSeen = new DateTimeOffset(new DateTime(2023, 2, 13, 18, 31, 57, 576, DateTimeKind.Unspecified).AddTicks(5490), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("ZTD.Entities.ResearchNodeUpgradeCondition", b =>
                {
                    ...
                    b.HasOne("ZTD.Entities.ResearchNodeLevel", null)
                        .WithMany("Conditions")
                        .HasForeignKey("ResearchNodeLevelId");
