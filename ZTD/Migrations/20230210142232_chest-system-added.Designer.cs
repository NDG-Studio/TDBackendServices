...
namespace ZTD.Migrations
{
    ...
    [Migration("20230210142232_chest-system-added")]
    partial class chestsystemadded
    {
            ...
            modelBuilder.Entity("ZTD.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstLogInDate = new DateTimeOffset(new DateTime(2023, 2, 10, 17, 22, 32, 137, DateTimeKind.Unspecified).AddTicks(1160), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsAndroid = true,
                            IsApe = true,
                            IsTutorialDone = false,
                            LastSeen = new DateTimeOffset(new DateTime(2023, 2, 10, 17, 22, 32, 137, DateTimeKind.Unspecified).AddTicks(1210), new TimeSpan(0, 3, 0, 0, 0)),
