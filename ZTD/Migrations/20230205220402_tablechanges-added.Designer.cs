...
namespace ZTD.Migrations
{
    ...
    [Migration("20230205220402_tablechanges-added")]
    partial class tablechangesadded
    {
            ...
            modelBuilder.Entity("ZTD.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstLogInDate = new DateTimeOffset(new DateTime(2023, 2, 6, 1, 4, 2, 428, DateTimeKind.Unspecified).AddTicks(6630), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsAndroid = true,
                            IsApe = true,
                            IsTutorialDone = false,
                            LastSeen = new DateTimeOffset(new DateTime(2023, 2, 6, 1, 4, 2, 428, DateTimeKind.Unspecified).AddTicks(6680), new TimeSpan(0, 3, 0, 0, 0)),
