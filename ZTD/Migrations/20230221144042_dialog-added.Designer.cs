...
namespace ZTD.Migrations
{
    ...
    [Migration("20230221144042_dialog-added")]
    partial class dialogadded
    {
            ...
            modelBuilder.Entity("ZTD.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstLogInDate = new DateTimeOffset(new DateTime(2023, 2, 21, 17, 40, 42, 173, DateTimeKind.Unspecified).AddTicks(2610), new TimeSpan(0, 3, 0, 0, 0)),
                            IsActive = true,
                            IsAndroid = true,
                            IsApe = true,
                            IsTutorialDone = false,
                            LastSeen = new DateTimeOffset(new DateTime(2023, 2, 21, 17, 40, 42, 173, DateTimeKind.Unspecified).AddTicks(2670), new TimeSpan(0, 3, 0, 0, 0)),
